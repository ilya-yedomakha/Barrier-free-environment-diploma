...
def convert_value(v):
    ...
    # QVariant які ще не розпаковують
    ...
    # Якщо це щось інше — повертаємо як є
    return v
    ...
    def do_POST(self):
        ...
        try:
            ...
            for feat in route_layer.getFeatures():
                ...
                # Повністю конвертуємо QVariant/QDateTime/QDate/QTime
                ...
                cur.execute("""
                    ...
                    DO UPDATE SET
                        ...
                        overall_accessibility_score = EXCLUDED.overall_accessibility_score,
                        rejection_reason            = EXCLUDED.rejection_reason,
                        status                      = EXCLUDED.status,
                        updated_at                  = EXCLUDED.updated_at,
                        updated_by                  = EXCLUDED.updated_by,
                        location_type_id            = EXCLUDED.location_type_id,
                        image_service_id            = EXCLUDED.image_service_id,
